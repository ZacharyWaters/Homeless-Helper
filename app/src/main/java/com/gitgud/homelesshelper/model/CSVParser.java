...
public class CSVParser {
    ...
    private static final Collection<Shelter> shelterList = new ArrayList<>();
    ...
    public CSVParser(Context content) {
        try {
            Resources fun = content.getResources();
            InputStream reader = fun.openRawResource(R.raw.homeless_shelter_database);
            //InputStream reader = content.getResources().
