...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mBackButtonView = findViewById(R.id.back_button);
    ...
    private void attemptLogin() {
        ...
        if ( (UserAuthentication.isValidPassword(password))
                ||  (UserAuthentication.isValidUsername(email))
                || ! (UserAuthentication.isValidCombination(password, email)) ) {
    ...
    private void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            ViewPropertyAnimator animator2 = animator1.alpha(show ? 0 : 1);
            ...
            ViewPropertyAnimator animator4 = mProgressView.animate();
...
//Remove this
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginActivity.
                        this, android.R.layout.simple_dropdown_item_1line, emailAddressCollection);
